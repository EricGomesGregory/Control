...
#include "Interaction/Abilities/ControlAbilityTarget_Interact.h"
#include "GameFramework/LightWeightInstanceSubsystem.h"


AControlAbilityTarget_Interact::AControlAbilityTarget_Interact(const FObjectInitializer& ObjectInitializer)
: Super(ObjectInitializer) {

}

FHitResult AControlAbilityTarget_Interact::PerformTrace(AActor* InSourceActor) {
